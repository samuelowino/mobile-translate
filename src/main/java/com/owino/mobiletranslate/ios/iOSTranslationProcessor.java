...
public class iOSTranslationProcessor implements TranslationProcessor {
    ...
    public void runTranslation(File outputFile, List<String> targetLanguages) throws Exception {
        var rootOutputFolder = processor.generateRootTranslationsOutputFolder();
        for (String targetLanguage : targetLanguages) {
            ...
            processor.placeTranslatedTextInDestinationDir(translatedTable, targetLanguage, rootOutputFolder);
        }
    }
}
